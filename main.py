...
title_font = "Fonts/scary.ttf"
instructions_font = 'Fonts/scary.ttf'

ghostbusters = Message(WIDTH//2 + 30, HEIGHT//2 - 90, 90, "GARUD", title_font, (255, 255, 255), win)
...
while running:
	...
	if main_menu:
		...
		MessageBox(win, about_font, 'ABOUT', info)
